    ...
    <div className="flex h-full min-h-[400px] flex-col items-center justify-center p-8 text-center">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <span className="font-mono text-[10px] uppercase tracking-[0.5em] text-neon/60 mb-4 block">Marketplace Protocol Pending</span>
          <h2 className="text-3xl font-black text-white uppercase tracking-tighter mb-6">Strategy Exchange Hub</h2>
          <p className="text-sm text-white/40 leading-relaxed max-w-md mx-auto mb-10">
            The decentralized strategy marketplace is currently under development. This feature is scheduled for release in **Phase 2: Alpha Expansion**.
          </p>
